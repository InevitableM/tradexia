...
// Single-concern calls (just DB, just cache) should keep using dbService /
...
export async function checkAndIncrementAnalysisQuota(userId: string): Promise<QuotaCheckResult> {
